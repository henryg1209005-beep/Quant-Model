...
DEFAULT_SETTINGS = Settings(
    ...
    llm_state_change_min_seconds=_get_int("LLM_STATE_CHANGE_MIN_SECONDS", 300),
    ...
    llm_request_retries=_get_int("LLM_REQUEST_RETRIES", 1),
    ...
    gemini_secondary_model=os.getenv("GEMINI_SECONDARY_MODEL", "gemini-1.5-flash-8b"),
